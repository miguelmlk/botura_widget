...
export function ChatWidget({
  ...
  return (
    <div className="flex h-[700px] flex-col rounded-3xl border border-zinc-200/50 bg-white shadow-2xl backdrop-blur-xl dark:border-zinc-800/50 dark:bg-zinc-900/95 overflow-hidden">
